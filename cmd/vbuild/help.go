...
func printUsage(out io.Writer) {
	...
	fmt.Fprintln(out, "  dataset          Dataset catalog commands")
	fmt.Fprintln(out, "  experiment       Experiment registry commands")
	fmt.Fprintln(out, "  lineage          Show dataset/task lineage")
	fmt.Fprintln(out, "  registry         Sync local registry")
	fmt.Fprintln(out, "  report           Generate compliance report")
